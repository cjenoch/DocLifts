...
ALTER TABLE "exercises" ALTER COLUMN "equipment_type" SET NOT NULL;
--> statement-breakpoint
ALTER TABLE "exercises" ADD CONSTRAINT "exercises_equipment_type_check" CHECK ("equipment_type" IN ('barbell', 'barbell-ez', 'machine-plate', 'machine-stack', 'cable', 'dumbbell', 'smith', 'bodyweight', 'band'));
--> statement-breakpoint
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_ended_after_started_check" CHECK ("ended_at" IS NULL OR "ended_at" >= "started_at");
--> statement-breakpoint
ALTER TABLE "days" ADD CONSTRAINT "days_position_non_neg_check" CHECK ("position" >= 1);
--> statement-breakpoint
ALTER TABLE "day_exercises" ADD CONSTRAINT "day_exercises_position_non_neg_check" CHECK ("position" >= 1);
--> statement-breakpoint
ALTER TABLE "prescribed_sets" ADD CONSTRAINT "prescribed_sets_position_non_neg_check" CHECK ("position" >= 1);
--> statement-breakpoint
ALTER TABLE "sets" ADD CONSTRAINT "sets_position_non_neg_check" CHECK ("position" >= 1);
